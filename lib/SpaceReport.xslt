			...
			<html>
				...
				<body>
					<xsl:for-each select="$XML">
						...
						<p>
							<span>
								<xsl:variable name="altova:seqContentStrings_11E90438">
								...
								<xsl:variable name="altova:sContent_11E90438" select="string($altova:seqContentStrings_11E90438)"/>
								<xsl:value-of select="$altova:sContent_11E90438"/>
							</span>
						</p>
						<p>
							<span>
										...
										<xsl:for-each select="parent::Components/parent::cb:COBIE">
											<xsl:for-each select="Spaces">
												<xsl:for-each select="Space[@Name=current-grouping-key()]">
													<table border="1">
														<xsl:variable name="altova:CurrContextGrid_13DDD0B8" select="."/>
													...
													<xsl:for-each select="parent::Components/parent::cb:COBIE">
														<xsl:for-each select="Types">
															<xsl:for-each select="Type[@Name=$currentTypeName]">
																<table border="1">
																	<xsl:variable name="altova:CurrContextGrid_13DDA6B8" select="."/>
																	<xsl:variable name="altova:ColumnData">
																		<altova:Internal/>
																	</xsl:variable>
																	<tbody>
													...
													<altova:level>
														<altova:marker altova:name="SpaceTypeComponentsBookMark">
															...
															<div id="ComponentDiv">
																...
																<table border="1">
																	<xsl:variable name="altova:CurrContextGrid_154FB350" select="."/>
																	<xsl:variable name="altova:ColumnData">
																		<altova:Internal/>
																	</xsl:variable>
																	<thead>
