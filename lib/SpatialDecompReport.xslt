		...
		<altova:main-document url="{if ($SV_BaseOutputFileName) then concat($SV_BaseOutputFileName,'.html') else ''}">
			<html>
				...
				<body>
					...
					<p>
						<span>
							<xsl:variable name="altova:seqContentStrings_1B567BF0">
							...
							<xsl:variable name="altova:sContent_1B567BF0" select="string($altova:seqContentStrings_1B567BF0)"/>
							<xsl:value-of select="$altova:sContent_1B567BF0"/>
						</span>
					</p>
					<p>
						<span>
							<xsl:text>This report provides a spatial decomposition of the model from facility, floor, zone, and spaces.</xsl:text>
						</span>
					</p>
					<hr/>
							...
							<xsl:for-each select="Facilities">
								<xsl:for-each select="Facility[1]">
									...
									<div>
										...
										<table border="1">
											<xsl:variable name="altova:CurrContextGrid_1749AE40" select="."/>
											...
											<xsl:for-each select="Floors">
												<xsl:for-each select="Floor">
													...
													<altova:level>
														...
														<table border="1">
															<xsl:variable name="altova:CurrContextGrid_1749C340" select="."/>
															<xsl:variable name="altova:ColumnData">
																<altova:Internal/>
															</xsl:variable>
															<thead>
																	...
																	<xsl:for-each select="Spaces">
																		<xsl:for-each select="Space[FloorName=$currentFloorName]">
																			...
																			<altova:level>
																				...
																				<table border="1">
																					<xsl:variable name="altova:CurrContextGrid_174ABE20" select="."/>
																					<xsl:variable name="altova:ColumnData">
																						<altova:Internal/>
																					</xsl:variable>
																					<thead>
