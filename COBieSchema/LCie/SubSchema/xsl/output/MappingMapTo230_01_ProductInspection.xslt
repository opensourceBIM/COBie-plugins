...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://asset.cobielite.cobie.erdc.org" xmlns:ns1="http://assettype.cobielite.cobie.erdc.org" xmlns:ns2="http://attribute.cobielite.cobie.erdc.org" xmlns:ns3="http://cobielite.cobie.erdc.org" xmlns:ns4="http://contact.cobielite.cobie.erdc.org" xmlns:cobielite="http://core.cobielite.cobie.erdc.org" xmlns:ns5="http://document.cobielite.cobie.erdc.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="ns0 ns1 ns2 ns3 ns4 ns5 xs fn">
	...
	<xsl:template match="/">
		...
		<ProductInspection xmlns="http://inspection230.lcie.cobielite.cobie.erdc.org" xmlns:att="http://attribute.lcie.cobielite.cobie.erdc.org" xmlns:con="http://contact.lcie.cobielite.cobie.erdc.org" xmlns:cobielite="http://core.cobielite.cobie.erdc.org" xmlns:doc="http://document.lcie.cobielite.cobie.erdc.org" xmlns:pid="http://inspection230.defs.lcie.cobielite.cobie.erdc.org" xmlns:lcie="http://lcie.cobielite.cobie.erdc.org">
			<xsl:attribute name="xsi:schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance" select="'http://inspection230.lcie.cobielite.cobie.erdc.org C:/Users/RDITLACB/git/cobieserver/COBieSchema/LCie/SubSchema/230_01_ProductInspection.xsd'"/>
			<pid:InformationExchangeID>230.01_ProductInspection</pid:InformationExchangeID>
				...
				<cobielite:AssetTypes>
					<xsl:for-each select="ns1:AssetType">
						...
						<pid:AssetType>
							...
							<xsl:for-each select="cobielite:Assets">
								<cobielite:Assets>
									<xsl:for-each select="ns0:Asset">
										<xsl:variable name="var5_AssetWarrantyStartDate" as="node()?" select="cobielite:AssetWarrantyStartDate"/>
										<xsl:variable name="var6_AssetInstallationDate" as="node()?" select="cobielite:AssetInstallationDate"/>
										...
										<xsl:variable name="var10_resultof_first" as="node()" select="cobielite:AssetSpaceAssignments"/>
										<pid:Asset>
											...
											<cobielite:AssetSpaceAssignments>
												<xsl:sequence select="($var10_resultof_first/@node(), $var10_resultof_first/node())"/>
											</cobielite:AssetSpaceAssignments>
											...
											<xsl:variable name="var11_result" as="xs:string">
												<xsl:choose>
													<xsl:when test="fn:exists($var6_AssetInstallationDate)">
														<xsl:sequence select="xs:string(xs:date(fn:string($var6_AssetInstallationDate)))"/>
													</xsl:when>
													<xsl:otherwise>
														<xsl:sequence select="'6/19/2013'"/>
													</xsl:otherwise>
												</xsl:choose>
											</xsl:variable>
											<cobielite:AssetInstallationDate>
												<xsl:sequence select="xs:string(xs:date($var11_result))"/>
											</cobielite:AssetInstallationDate>
											<xsl:variable name="var12_result" as="xs:string">
												<xsl:choose>
													<xsl:when test="fn:exists($var5_AssetWarrantyStartDate)">
														<xsl:sequence select="xs:string(xs:date(fn:string($var5_AssetWarrantyStartDate)))"/>
													</xsl:when>
													<xsl:otherwise>
														<xsl:sequence select="'6/19/2013'"/>
													</xsl:otherwise>
											...
											<cobielite:AssetWarrantyStartDate>
												<xsl:sequence select="xs:string(xs:date($var12_result))"/>
											</cobielite:AssetWarrantyStartDate>
							...
							<xsl:for-each select="cobielite:AssetTypeAttributes">
								<cobielite:AssetTypeAttributes>
									<xsl:for-each select="ns2:Attribute">
										...
										<xsl:variable name="var19_propertySetExternalIdentifier" as="node()?" select="@cobielite:propertySetExternalIdentifier"/>
										<xsl:variable name="var20_propertySetName" as="node()?" select="@cobielite:propertySetName"/>
										<att:Attribute>
											...
											<xsl:if test="fn:exists($var20_propertySetName)">
												<xsl:attribute name="cobielite:propertySetName" select="fn:string($var20_propertySetName)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var19_propertySetExternalIdentifier)">
												<xsl:attribute name="cobielite:propertySetExternalIdentifier" select="fn:string($var19_propertySetExternalIdentifier)"/>
											</xsl:if>
							...
							<xsl:for-each select="cobielite:AssetTypeIssues">
								<cobielite:AssetTypeIssues>
									<xsl:sequence select="()"/>
								</cobielite:AssetTypeIssues>
							</xsl:for-each>
						</pid:AssetType>
			...
			<xsl:for-each select="$var1_Facility/cobielite:Contacts">
				<cobielite:Contacts>
					<xsl:for-each select="ns4:Contact">
						<xsl:variable name="var21_externalSystemName" as="node()?" select="@cobielite:externalSystemName"/>
						<xsl:variable name="var22_externalEntityName" as="node()?" select="@cobielite:externalEntityName"/>
						<xsl:variable name="var23_externalID" as="node()?" select="@cobielite:externalID"/>
						<con:Contact>
							<xsl:if test="fn:exists($var22_externalEntityName)">
								<xsl:attribute name="cobielite:externalEntityName" select="fn:string($var22_externalEntityName)"/>
							</xsl:if>
							<xsl:if test="fn:exists($var23_externalID)">
								<xsl:attribute name="cobielite:externalID" select="fn:string($var23_externalID)"/>
							</xsl:if>
							<xsl:if test="fn:exists($var21_externalSystemName)">
								<xsl:attribute name="cobielite:externalSystemName" select="fn:string($var21_externalSystemName)"/>
							</xsl:if>
