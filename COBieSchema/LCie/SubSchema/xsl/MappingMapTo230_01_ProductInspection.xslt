...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://asset.cobielite.cobie.erdc.org" xmlns:ns1="http://assettype.cobielite.cobie.erdc.org" xmlns:ns2="http://attribute.cobielite.cobie.erdc.org" xmlns:ns3="http://cobielite.cobie.erdc.org" xmlns:ns4="http://contact.cobielite.cobie.erdc.org" xmlns:cobielite="http://core.cobielite.cobie.erdc.org" xmlns:ns5="http://document.cobielite.cobie.erdc.org" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" exclude-result-prefixes="ns0 ns1 ns2 ns3 ns4 ns5 xs fn">
	...
	<xsl:template match="/">
		...
		<ProductInspection xmlns="http://productinspection230.lcie.cobielite.cobie.erdc.org" xmlns:att="http://attribute.lcie.cobielite.cobie.erdc.org" xmlns:con="http://contact.lcie.cobielite.cobie.erdc.org" xmlns:cobielite="http://core.cobielite.cobie.erdc.org" xmlns:doc="http://document.lcie.cobielite.cobie.erdc.org" xmlns:lcie="http://lcie.cobielite.cobie.erdc.org" xmlns:pid="http://productinspection230.defs.lcie.cobielite.cobie.erdc.org">
			<xsl:attribute name="xsi:schemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance" select="'http://productinspection230.lcie.cobielite.cobie.erdc.org ../230_01_ProductInspection.xsd'"/>
							...
							<xsl:for-each select="cobielite:AssetTypeAttributes">
								<cobielite:AssetTypeAttributes>
									<xsl:for-each select="ns2:Attribute">
										<xsl:variable name="var16_propertySetExternalIdentifier" as="node()?" select="@cobielite:propertySetExternalIdentifier"/>
										<xsl:variable name="var17_propertySetName" as="node()?" select="@cobielite:propertySetName"/>
										...
										<att:Attribute>
											...
											<xsl:if test="fn:exists($var17_propertySetName)">
												<xsl:attribute name="cobielite:propertySetName" select="fn:string($var17_propertySetName)"/>
											</xsl:if>
											<xsl:if test="fn:exists($var16_propertySetExternalIdentifier)">
												<xsl:attribute name="cobielite:propertySetExternalIdentifier" select="fn:string($var16_propertySetExternalIdentifier)"/>
											</xsl:if>
