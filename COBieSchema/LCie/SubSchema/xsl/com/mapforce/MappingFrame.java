...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jName010_ProductTypeTemplate2Label0 = new JLabel();
	JTextField jName010_ProductTypeTemplate2TextField0 = new JTextField();

	JLabel jcobielite2Label1 = new JLabel();
	JTextField jcobielite2TextField1 = new JTextField();
	...
	protected void fillScrollPane() {
		...
		jName010_ProductTypeTemplate2Label0.setText("Source instance of 010_ProductTypeTemplate.xsd:");
		jName010_ProductTypeTemplate2Label0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jName010_ProductTypeTemplate2Label0, null);
		jName010_ProductTypeTemplate2TextField0.setText("010_ProductTypeTemplate.xml");
		jName010_ProductTypeTemplate2TextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jName010_ProductTypeTemplate2TextField0.setEditable(false);
		jPanelStructures.add(jName010_ProductTypeTemplate2TextField0, null);

		jcobielite2Label1.setText("Instance of cobielite.xsd:");
		jcobielite2Label1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jcobielite2Label1, null);
		jcobielite2TextField1.setText("../../../COBieLite/xsd/cobielite.xml");
		jcobielite2TextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jcobielite2TextField1.setEditable(false);
		jPanelStructures.add(jcobielite2TextField1, null);
