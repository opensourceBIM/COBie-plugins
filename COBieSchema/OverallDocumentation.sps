...
<structure version="16" html-doctype="HTML4 Transitional" compatibility-view="IE9" relativeto="*XML" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="C:\Users\RDITLACB\Documents\Altova\XMLSpy2013\Documentation\Schema\SchemaDocumentation.xsd" workingxmlfile="C:\Users\RDITLACB\Documents\Altova\XMLSpy2013\Documentation\Schema\SampleData\Sample.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
						...
						<children>
							<template subtype="element" match="n1:Annotation">
								<children>
									<condition>
										<children>
											<conditionbranch xpath="contains(@name,&apos;appinfo&apos;)"/>
											<conditionbranch xpath="not(contains(@name,&apos;appinfo&apos;))">
												<children>
													<template subtype="attribute" match="name">
														<children>
															<content subtype="regular">
