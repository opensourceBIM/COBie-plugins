					...
					<template subtype="source" match="XML">
						<children>
							<paragraph paragraphtag="h1">
								<children>
									<text fixtext="COBie System Report"/>
								</children>
							</paragraph>
							...
							<paragraph paragraphtag="p">
								<children>
									...
									<text fixtext="This report provides a listing of Systems contained in the model and their corresponding components"/>
								</children>
							</paragraph>
							<line/>
							<template subtype="element" match="cb:COBIE">
								<children>
									<template subtype="element" match="Systems">
										<children>
											<toc name="toc">
												<children>
													<paragraph paragraphtag="h1">
											...
											<line/>
											<template subtype="element" levelflag="1" filter="not(./@Name=preceding-sibling::System/@Name)" match="System">
												<children>
													<paragraph paragraphtag="h2">
														<children>
													...
													<paragraph paragraphtag="p">
														<children>
															<template subtype="userdefined" match="parent::Systems/parent::cb:COBIE">
																<children>
																	<template subtype="element" match="Systems">
																		<children>
																			<paragraph paragraphtag="h3">
																			...
																			<template subtype="element" filter="@Name=$CurrentSystemName" match="System">
																				<children>
																					<template subtype="element" filter="not(text()=preceding-sibling::element()/ComponentNames)" match="ComponentNames">
																						<children>
																							<content/>
																						</children>
																						<variables>
																							<variable name="currentComponentNames" value="./text()" valuetype="xs:string"/>
																					...
																					<condition>
																						<children>
																							<conditionbranch xpath="position() mod 1 = 0">
																								<children>
																									<paragraph paragraphtag="p"/>
																								</children>
																							</conditionbranch>
													...
													<paragraph paragraphtag="h3">
														<children>
															<text fixtext="System Information"/>
														</children>
													</paragraph>
													<tgrid>
														<properties border="1"/>
												...
												<variables>
													<variable name="CurrentSystemName" value="./@Name" valuetype="xs:string"/>
												</variables>
											</template>
										</children>
										<variables/>
