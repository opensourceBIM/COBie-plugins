																...
																<children>
																	<template subtype="userdefined" match="current-grouping-key()">
																		...
																		<variables>
																			...
																			<variable name="errorCount" value="if (string($rowCount)!=&apos;NaN&apos; and $rowCount&gt;0) then string(count(distinct-values($failedAsserts/@location))) else &apos;n/a&apos;" valuetype="xs:string"/>
...
$worksheetName" valuetype="xs:string"/>
									...
									<template subtype="uservariable" groupingtype="group-by" groupingmatch="preceding-sibling::svrl:fired-rule[1]/@id" match="$errorRoleContent">
															...
															<template subtype="userdefined" groupingtype="group-by" groupingmatch="@flag" match="current-group()">
																<children>
																	<template subtype="userdefined" match="current-grouping-key()">
																		...
																		<variables>
																			<variable name="incorrectFieldOccurenceCount" value="count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos;]/@location))" valuetype="xs:integer"/>
										...
										<variables>
											...
											<variable name="countDistinctRowErrors" value="count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos;]/@location))" valuetype="xs:integer"/>
								...
								<children>
									<marker name="Level1Section">
										<children>
											...
											<paragraph paragraphtag="h2">
												<children>
													<num-lvl format="1.1.1"/>
													<text fixtext=" Detailed Error Report Grouped by Error Type"/>
												</children>
											</paragraph>
										</children>
									</marker>
									...
									<template subtype="userdefined" groupingtype="group-by" groupingmatch="preceding-sibling::svrl:fired-rule[1]/@id" match="$errorRoleContent[name(.)=&apos;svrl:failed-assert&apos;]">
										...
										<variables>
											<variable name="ruleGroupName" value="string(current-grouping-key())" valuetype="xs:string"/>
											<variable name="isWorksheet" value="string-length($ruleGroupName)-string-length(translate($ruleGroupName,&apos;.&apos;,&apos;&apos;))=1" valuetype="xs:boolean"/>
											<variable name="errorCount" value="count(distinct-values(current-group()/@location))" valuetype="xs:integer"/>
										</variables>
									</template>
								</children>
							</level>
																...
																<children>
																	...
																	<tgrid>
																		...
																		<children>
																			...
																			<tgridbody-rows>
																				<children>
																					<template subtype="userdefined" groupingtype="group-adjacent" groupingmatch="@id" match="current-group()">
																						<children>
																							<template subtype="userdefined" match="current-group()">
																								<children>
																									<tgridrow>
