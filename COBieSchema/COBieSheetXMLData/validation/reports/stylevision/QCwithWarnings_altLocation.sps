...
<structure version="16" html-doctype="XHTML1 Transitional" compatibility-view="IE7" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="0" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="svrl.xsd" workingxmlfile="C:\Users\RDITLACB\git\cobieserver\COBieSchema\COBieSheetXMLData\validation\schematron\svrlAltLocation.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
