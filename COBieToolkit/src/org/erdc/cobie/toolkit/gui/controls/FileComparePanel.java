...
import org.erdc.cobie.toolkit.gui.controls.COBieApplicationTaskPanel.TaskPanelStateValue;
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(progressBar, GroupLayout.PREFERRED_SIZE, 522, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblProgress, GroupLayout.PREFERRED_SIZE, 507, GroupLayout.PREFERRED_SIZE))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnSubmit, GroupLayout.PREFERRED_SIZE, 87, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
							.addComponent(cobieFileLoaderBaseline, GroupLayout.PREFERRED_SIZE, 615, GroupLayout.PREFERRED_SIZE))
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
							.addComponent(cobieFileLoaderRevision, GroupLayout.PREFERRED_SIZE, 615, GroupLayout.PREFERRED_SIZE)))
