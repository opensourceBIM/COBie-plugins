...
public class CobieExportOptionsGui extends JDialog implements ActionListener
{
	...
	private CobieToolkitGui cobieToolkitGui;
	...
	public CobieExportOptionsGui(final CobieToolkitGui cobieToolkitGui)
	{
		setResizable(false);
		this.cobieToolkitGui = cobieToolkitGui;
		initJDialogOptions();
		initActionControls();
	...
	private void applyChanges()
	{
		try
		{
			cobieExportOptionsDocument.save(cobieToolkitGui.getCobieToolkit().getCobieExportOptionsFile());
		}
		catch(Exception ex)
		{
	...
	private void initCobieExportOptionsDocument()
	{
		try
		{
			cobieExportOptionsDocument =
					COBieExportOptionsDocument.Factory.parse(cobieToolkitGui.getCobieToolkit().getCobieExportOptionsFile());
		}
		catch(Exception ex)
		{
	...
	public CobieToolkitGui getCobieToolkitGui()
	{
		return cobieToolkitGui;
	}
}
