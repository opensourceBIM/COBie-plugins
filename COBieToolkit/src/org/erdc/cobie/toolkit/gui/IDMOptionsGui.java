...
public class IDMOptionsGui extends JDialog implements ActionListener
{
     ...
     * 
     */
    private static final long serialVersionUID = -8656072097945049787L;
    ...
    public IDMOptionsGui(final CobieToolkitGui cobieToolkitGui)
    {
        ...
        setModal(true);
        cobieToolkit = cobieToolkitGui.getCobieToolkit();
                ...
                groupLayout
                        ...
                        .addGroup(
                                groupLayout
                                        ...
                                        .addGroup(
                                                groupLayout.createSequentialGroup().addContainerGap().addComponent(btnSubmit)
                                                ...
                                                groupLayout
                                                        ...
                                                        .addGroup(
                                                                groupLayout.createParallelGroup(Alignment.LEADING)
                                                                        ...
                                                                        .addComponent(cbIDM, 0, 385, Short.MAX_VALUE).addComponent(lblDescription)
                ...
                groupLayout
                        ...
                        .addGroup(
                                groupLayout.createParallelGroup(Alignment.BASELINE)
                                        ...
                                        .addComponent(btnCancel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)).addGap(26)));
    ...
    private ObjectIDMPlugin getSelectedPlugin()
    {
        ...
        if (selectedItem instanceof ControlTextItem)
        {
            ...
            selectedPlugin = cobieToolkit.getControlTextItemToIDMPlugin().get(selectedTextItem);
        }
    ...
    {
        addNullItem();
        for (ControlTextItem controlTextItem : cobieToolkit.getControlTextItemToIDMPlugin().keySet())
        {
