...
@import  url("SpaceReport.css");
				...
				<body>
					...
					<div>
						<span>
							<xsl:variable name="altova:seqContentStrings_0F34C1D8">
							...
							<xsl:variable name="altova:sContent_0F34C1D8" select="string($altova:seqContentStrings_0F34C1D8)"/>
							<xsl:value-of select="$altova:sContent_0F34C1D8"/>
						</span>
					</div>
	...
	<xsl:template match="svrl:schematron-output">
		<h1>
			<span>
				<xsl:text>Worksheet Counts</xsl:text>
			</span>
		</h1>
		...
		<hr/>
		<xsl:for-each-group group-by="preceding-sibling::svrl:fired-rule[1]/@id" select="svrl:failed-assert">
...
concat(sps:singularizeSheetName($locationPrefix),&apos;[*]&apos;)"/>
					...
					<altova:level>
						...
						<table border="1">
							<xsl:variable name="altova:CurrContextGrid_0F641098" select="."/>
