...
import org.bimserver.cobie.satellite.gui.ActivityLogger;
...
public abstract class Activity extends NotificationInterfaceAdapter {
	...
	public abstract void activate(CobieSatelliteServer satelliteServer);
	public abstract void deactivate(CobieSatelliteServer satelliteServer);
