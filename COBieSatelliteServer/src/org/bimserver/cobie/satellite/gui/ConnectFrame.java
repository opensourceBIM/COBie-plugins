...
public class ConnectFrame extends JDialog {
	...
	public ConnectFrame(final CobieSatelliteGui satelliteGui, CobieSatelliteServerSettings settings) {
		...
		save.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					CobieSatelliteServerSettings settings = new CobieSatelliteServerSettings();
