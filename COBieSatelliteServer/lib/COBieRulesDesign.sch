...
concat(upper-case(substring($x, 1, 1)), lower-case(substring($x, 2))), ' ')"/>
	...
	<iso:pattern id="COBieValidation.General">
		...
		<iso:rule context="//Types/Type" id="COBie.Types.Type" role="Errors">
			...
			<iso:assert id="Type.ModelNumber.NotEmpty" test="iso:validStringOrNA(ModelNumber)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'ModelNumber')"/>
			</iso:assert>
			<iso:assert id="Type.Manufacturer.NotEmpty" test="iso:validStringOrNA(Manufacturer)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'Manufacturer')"/>
			</iso:assert>

			<iso:assert id="Type.WarrantyGuarantorParts.NotEmpty" test="iso:validStringOrNA(WarrantyGuarantorParts)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'WarrantyGuarantorParts')"/>
			</iso:assert>

			<iso:assert id="Type.WarrantyGuarantorLabor.NotEmpty" test="iso:validStringOrNA(WarrantyGuarantorLabor)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'WarrantyGuarantorLabor')"/>
			</iso:assert>

			<iso:assert id="Type.WarrantyDurationLabor.NotEmpty" test="iso:validNumberZeroOrGreater(WarrantyDurationLabor)">
			...
			<iso:assert id="Type.WarrantyDurationUnit.NotEmpty" test="iso:validStringOrNA(WarrantyDurationUnit)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'WarrantyDurationUnit')"/>
			</iso:assert>
			<iso:assert id="Type.DurationUnit.NotEmpty" test="iso:validStringOrNA(DurationUnit)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'DurationUnit')"/>
			</iso:assert>
			<iso:assert id="Type.NominalLength.NotEmpty" test="iso:validStringOrNA(NominalLength)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'NominalLength')"/>
			</iso:assert>
			<iso:assert id="Type.NominalWidth.NotEmpty" test="iso:validStringOrNA(NominalWidth)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'NominalWidth')"/>
			</iso:assert>
			<iso:assert id="Type.NominalHeight.NotEmpty" test="iso:validStringOrNA(NominalHeight)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'NominalHeight')"/>
			</iso:assert>
		...
		<iso:rule context="//Components/Component" id="COBie.Components.Component" role="Errors">
			...
			<iso:assert id="Component.InstallationDate.NotEmpty" test="iso:validStringOrNA(InstallationDate)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'InstallationDate')"/>
			</iso:assert>
			<iso:assert id="Component.WarrantyStartDate.NotEmpty" test="iso:validStringOrNA(WarrantyStartDate)">
				<value-of select="iso:notEmptyMessage(name(.),@Name,'WarrantyStartDate')"/>
			</iso:assert>
