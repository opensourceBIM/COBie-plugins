...
@import  url("SpaceReport.css");
				...
				<body>
					<h1>
						<span>
							<xsl:text>COBie Compliance Verification Report</xsl:text>
						</span>
					</h1>
					<div>
						<span>
							<xsl:variable name="altova:seqContentStrings_11983128">
							...
							<xsl:variable name="altova:sContent_11983128" select="string($altova:seqContentStrings_11983128)"/>
							<xsl:value-of select="$altova:sContent_11983128"/>
						</span>
					</div>
					<p>
						<span>
...
concat(sps:singularizeSheetName($locationPrefix),&apos;[*]&apos;)"/>
					...
					<altova:level>
						...
						<table border="1">
							<xsl:variable name="altova:CurrContextGrid_13DDCBD8" select="."/>
