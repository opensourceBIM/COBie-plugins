...
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.ZoneDeserializer;
...
public class IfcToZone
{
    ...
    {
        IfcSingleValueToCOBieString sValStr = new org.erdc.cobie.shared.bimserver.ifc.serialization.cobietab.IfcSingleValueToCOBieString(val);
