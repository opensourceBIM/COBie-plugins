...
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.modelhandlers.COBieOidProvider;
...
public class FromCOBieToIfc
{
    ...
    public FromCOBieToIfc(COBIEType cobie) throws IfcModelInterfaceException
    {
        init(cobie);
    }
