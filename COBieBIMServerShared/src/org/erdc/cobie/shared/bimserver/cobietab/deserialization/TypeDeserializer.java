...
import org.erdc.cobie.shared.bimserver.VendorExtHandler;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.modelhandlers.IfcCommonHandler;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.COBie_Warranty;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.Pset_Asset;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.Pset_EconomicImpactValues;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.Pset_ManufacturersTypeInformation;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.Pset_ServiceLife;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.Pset_Specification;
...
public class TypeDeserializer
{
    ...
    public List<IfcClassificationReference> classificationReferenceFromType(TypeType cobieType) throws IfcModelInterfaceException
    {
    ...
    private IfcPropertyEnumeration createAssetTypeEnumeration()
    {
        ...
        return ifcCommonHandler.getPropertySetHandler().enumerationFromNameAndValues(Pset_Asset.getAssetAccountingTypeEnumName(),
                Pset_Asset.getAssetAccountingTypeAllowedValues(), "");
    }
            ...
            for (TypeType type : types.getTypeArray())
            {
                try
                {
                    ...
                    if ((newTypeObject != null) && !model.containsType(name))
                    {
                        ...
                        ifcCommonHandler.getPropertySetHandler().addPropertiesAndPropertySetToTypeObject(newTypeObject, psetWarranty, false);
                        ...
                        if (assetTypeEnumeration == null)
                        {
                            ...
                            {
                                model.add(assetTypeEnumeration, ifcCommonHandler.getOidProvider());
                            }
                        }
