...
import org.erdc.cobie.shared.bimserver.GuidCompressor;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.modelhandlers.IfcCommonHandler;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.modelhandlers.IfcUnitHandler;
import org.erdc.cobie.shared.bimserver.cobietab.deserialization.propertysets.PropertyUtility;
import org.erdc.cobie.shared.bimserver.cobietab.key.KeyedAttributeType;
...
public class AttributeDeserializer
{
    ...
    public List<IfcClassificationReference> classificationReferencesFromAttribute(AttributeType attribute) throws IfcModelInterfaceException
    {
            ...
            String propertyDescription) throws Exception
    {
        ...
        CaseInsensitiveStringList caseAgnosticAllowedValues = new CaseInsensitiveStringList(allowedValsList);
    ...
    public IfcPropertySet newPropertySetFromAttribute(AttributeType attribute) throws IfcModelInterfaceException
    {
    ...
    public IfcProperty propertyFromAttribute(AttributeType attribute) throws Exception
    {
        ...
        {
            IfcUnit ifcUnit = IfcUnitHandler.unitFromStringAndUnitType(unit, IfcUnitEnum.USERDEFINED);
