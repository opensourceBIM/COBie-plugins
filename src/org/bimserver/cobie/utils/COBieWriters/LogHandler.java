...
public class LogHandler
{
	...
	public LogHandler(CobieSheetName sheet,Logger sheetLogger)
	{
		...
		PluralSheetName = this.sheetNamePlurals.get(sheet);
	}	
	
	public LogHandler(LogHandler existingCobieStringBuilder)
	{
		this.rowCount = existingCobieStringBuilder.rowCount;
		this.errorCount = existingCobieStringBuilder.errorCount;
		this.SheetName = existingCobieStringBuilder.SheetName;
		this.PluralSheetName = existingCobieStringBuilder.PluralSheetName;
		sheetNamePlurals = new HashMap<CobieSheetName,String>();
