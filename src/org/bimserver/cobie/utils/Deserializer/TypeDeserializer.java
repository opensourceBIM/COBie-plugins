...
import org.bimserver.cobie.utils.IFCWriters.PropertySets.Pset_Asset;
import org.bimserver.cobie.utils.IFCWriters.PropertySets.Pset_EconomicImpactValues;
import org.bimserver.cobie.utils.IFCWriters.PropertySets.Pset_ManufacturersTypeInformation;
import org.bimserver.cobie.utils.IFCWriters.PropertySets.Pset_ServiceLife;
import org.bimserver.cobie.utils.IFCWriters.PropertySets.Pset_Specification;
import org.bimserver.cobie.utils.IFCWriters.PropertySets.Pset_Warranty;
	...
	public void deserializeTypes()
	{
		...
		if (types != null)
		{
			for (TypeType type : types.getTypeArray())
			{
				...
				{
					name = type.getName();
					externalObject = type.getExtObject();
