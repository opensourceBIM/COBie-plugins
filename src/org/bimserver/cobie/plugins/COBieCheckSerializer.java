...
import org.bimserver.cobie.utils.HtmlUtils;
...
public class COBieCheckSerializer extends COBieLiteSerializer
{
	...
	protected void schematronReportToOutputStream(OutputStream outputStream)
	{
		...
		ByteArrayInputStream targetDocStream = new ByteArrayInputStream(this.getCOBieDocument().toString().getBytes());
