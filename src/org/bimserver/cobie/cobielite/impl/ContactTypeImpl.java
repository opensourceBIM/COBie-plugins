 ...
 */
public class ContactTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.bimserver.cobie.cobielite.ContactType
{
     ...
     */
    public org.bimserver.cobie.cobielite.EmailAddressType xgetEmail()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.bimserver.cobie.cobielite.EmailAddressType target = null;
            target = (org.bimserver.cobie.cobielite.EmailAddressType)get_store().find_element_user(EMAIL$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetEmail(org.bimserver.cobie.cobielite.EmailAddressType email)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.bimserver.cobie.cobielite.EmailAddressType)get_store().add_element_user(EMAIL$0);
            }
            target.set(email);
        }
    }
    ...
    public org.bimserver.cobie.cobielite.EmailAddressType xgetCreatedBy()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.bimserver.cobie.cobielite.EmailAddressType target = null;
            target = (org.bimserver.cobie.cobielite.EmailAddressType)get_store().find_element_user(CREATEDBY$2, 0);
            return target;
        }
    }
    ...
    public void xsetCreatedBy(org.bimserver.cobie.cobielite.EmailAddressType createdBy)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.bimserver.cobie.cobielite.EmailAddressType)get_store().add_element_user(CREATEDBY$2);
            }
