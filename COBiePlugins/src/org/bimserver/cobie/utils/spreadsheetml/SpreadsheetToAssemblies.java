...
import org.bimserver.shared.cobie.COBieTokenUtility.AssemblyColumnNameLiterals;
	...
	public static void writeAssembliesToCOBie(COBIEType cobie,Workbook workbook)
	{
		COBIEType.Assemblies assemblies =  cobie.addNewAssemblies();   	      	    
	   	...
	   	Map<String,Integer> columnDictionary =
	   			COBieSpreadSheet.GetWorksheetColumnDictionary(sheet, getAssemblyColumnNames());
	   	String assemblyName="";
