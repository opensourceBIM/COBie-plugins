...
import org.bimserver.shared.cobie.COBieTokenUtility.ComponentColumnNameLiterals;
...
public class SpreadSheetToComponents
{
	...
	public static void writeComponentsToCOBie(COBIEType cType,Workbook workbook)
	{
		...
		Map<String,Integer> columnDictionary =
				COBieSpreadSheet.GetWorksheetColumnDictionary(sheet,getComponentColumns());
