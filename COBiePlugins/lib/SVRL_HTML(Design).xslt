...
@import  url("SpaceReport.css");
				...
				<body>
					...
					<div>
						<span>
							<xsl:variable name="altova:seqContentStrings_0C4DD708">
							...
							<xsl:variable name="altova:sContent_0C4DD708" select="string($altova:seqContentStrings_0C4DD708)"/>
							<xsl:value-of select="$altova:sContent_0C4DD708"/>
						</span>
					</div>
