...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:n1="http://purl.oclc.org/dsdl/svrl" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;HtmlReportGroupedwTOC&apos;" as="xs:string?"/>
...
@import  url("SpaceReport.css");
				...
				<body>
					...
					<div>
						<span>
							<xsl:variable name="altova:seqContentStrings_0C4E3208">
							...
							<xsl:variable name="altova:sContent_0C4E3208" select="string($altova:seqContentStrings_0C4E3208)"/>
							<xsl:value-of select="$altova:sContent_0C4E3208"/>
						</span>
					</div>
					...
					<div>
						<xsl:for-each select="$XML">
							<xsl:apply-templates select="n1:schematron-output"/>
						</xsl:for-each>
					</div>
				</body>
			</html>
		...
		<altova:toc altova:design-id="{generate-id()}">
			...
			<xsl:for-each select="ancestor::*[self::altova:level | self::altova:main-document][1]">
				<xsl:for-each select="descendant::altova:level[ ancestor::*[self::altova:level | self::altova:main-document][1] is current() ]">
					...
					<h3>
						<xsl:for-each select="descendant::altova:marker[ @altova:name = 'RuleGroupBookmark' and ancestor::altova:level[1] is current() ]">
					...
					<xsl:for-each select="descendant::altova:level[ ancestor::altova:level[1] is current() ]">
						...
						<h4 style="padding-left:25px; ">
							<xsl:for-each select="descendant::altova:marker[ @altova:name = 'ErrorLocationBookmark' and ancestor::altova:level[1] is current() ]">
								<xsl:variable name="altova:current-marker-id" select="generate-id()"/>
								<a href="{concat(altova:calc-relative-path($altova:source-document/@url,ancestor::*[self::altova:result-document | self::altova:main-document][1]/@url),'#',generate-id())}">
									<span>
										<xsl:choose>
	...
	<xsl:template match="n1:schematron-output">
		<xsl:for-each-group group-by="preceding-sibling::n1:fired-rule[1]/@id" select="n1:failed-assert">
			<xsl:variable name="ruleGroupName" as="xs:string" select="string(current-grouping-key())"/>
			<altova:level>
				<altova:marker altova:name="RuleGroupBookmark">
					<span>
						<xsl:text>&#160;</xsl:text>
					</span>
					<h2>
				...
				<xsl:for-each-group group-by="@location" select="current-group()">
					...
					<xsl:variable name="cobieRowName" as="xs:string" select="substring-before(n1:text ,&apos;:&apos; )"/>
...
concat(sps:singularizeSheetName($locationPrefix),&apos;[*]&apos;)"/>
					<xsl:variable name="lastRuleFired" as="xs:string" select="preceding-sibling::n1:fired-rule[1]/@id"/>
					<altova:level>
						<h3>
							<altova:marker altova:name="ErrorLocationBookmark">
								<span>
									<altova:num-lvl altova:format="1.1.1"/>
								</span>
						...
						<table border="1">
							<xsl:variable name="altova:CurrContextGrid_0BD89DD0" select="."/>
