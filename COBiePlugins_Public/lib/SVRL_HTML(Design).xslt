				...
				<body>
					<h1>
						<span style="font-size:xx-large; ">
							<xsl:text>COBie QC report - Design Deliverable</xsl:text>
						</span>
					</h1>
					<p>
						<span>
							<xsl:variable name="altova:seqContentStrings_16EB0B88">
							...
							<xsl:variable name="altova:sContent_16EB0B88" select="string($altova:seqContentStrings_16EB0B88)"/>
							<xsl:value-of select="$altova:sContent_16EB0B88"/>
						</span>
					</p>
				...
				<altova:level>
					...
					<p style="text-align:left; ">
						...
						<xsl:for-each select="$percentCorrect">
							<span style="font-style:italic; ">
								<xsl:variable name="altova:seqContentStrings_16EB6B20">
									<xsl:value-of select="format-number(number(string(.)), '##0.##')"/>
								</xsl:variable>
								<xsl:variable name="altova:sContent_16EB6B20" select="string($altova:seqContentStrings_16EB6B20)"/>
								<xsl:value-of select="$altova:sContent_16EB6B20"/>
							</span>
							<span style="font-style:italic; ">
								<xsl:text>% correct</xsl:text>
							</span>
