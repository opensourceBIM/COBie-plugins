...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;DesignQC&apos;" as="xs:string?"/>
...
@import  url("SpaceReport.css");
				...
				<body>
					...
					<div>
						<span>
							<xsl:variable name="altova:seqContentStrings_10DFFD58">
							...
							<xsl:variable name="altova:sContent_10DFFD58" select="string($altova:seqContentStrings_10DFFD58)"/>
							<xsl:value-of select="$altova:sContent_10DFFD58"/>
						</span>
					</div>
	...
	<xsl:template match="svrl:schematron-output">
		<xsl:variable name="WorksheetCountRole" as="xs:string" select="string(&apos;WorksheetCount&apos;)"/>
		<xsl:variable name="WorksheetErrorRole" as="xs:string" select="string(&apos;WorksheetErrors&apos;)"/>
		<altova:level>
			...
			<xsl:for-each-group group-by="preceding-sibling::svrl:fired-rule[1]/@id" select="svrl:failed-assert[preceding-sibling::svrl:fired-rule/@role=$WorksheetErrorRole] |
svrl:successful-report[preceding-sibling::svrl:fired-rule/@role=$WorksheetErrorRole]">
				...
				<xsl:variable name="countDistinctRowErrors" as="xs:integer" select="$countTotalSheetRows - count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos;]/@location))"/>
				<xsl:variable name="percentCorrect" as="xs:double" select="100*(( $countDistinctRowErrors) div $countTotalSheetRows)"/>
				<altova:level>
					<altova:marker altova:name="Level1Section">
						<span>
							<xsl:text>&#160;</xsl:text>
					...
					<p style="text-align:left; ">
						...
						<xsl:for-each select="$countDistinctRowErrors">
							<span style="font-style:italic; ">
								<xsl:value-of select="."/>
							</span>
						</xsl:for-each>
						...
						<xsl:for-each select="$percentCorrect">
							<span style="font-style:italic; ">
								<xsl:variable name="altova:seqContentStrings_10E024F0">
									<xsl:value-of select="format-number(number(string(.)), '##0.##')"/>
								</xsl:variable>
								<xsl:variable name="altova:sContent_10E024F0" select="string($altova:seqContentStrings_10E024F0)"/>
								<xsl:value-of select="$altova:sContent_10E024F0"/>
							</span>
							<span style="font-style:italic; ">
								<xsl:text>% correct</xsl:text>
							</span>
					...
					<p style="text-align:left; ">
						<xsl:for-each select="distinct-values(current-group()[name(self::element())=&apos;svrl:successful-report&apos;]/svrl:text)">
							<span>
								<xsl:text>&#160;</xsl:text>
							</span>
							<xsl:choose>
					...
					<p style="text-align:left; ">
						<xsl:for-each-group group-by="@flag" select="current-group()">
							<xsl:for-each select="current-grouping-key()">
								<xsl:variable name="leftSideRuleGroupName" as="xs:string" select="substring-before(current-grouping-key(),string(&apos;.&apos;))"/>
								<xsl:variable name="incorrectFieldOccurenceCount" as="xs:integer" select="count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos;]/@location))"/>
		...
		<altova:level>
			<altova:marker altova:name="Level1Section">
				...
				<h2>
					...
					<span>
						<xsl:text> Detailed Error Report</xsl:text>
					</span>
				</h2>
			</altova:marker>
			<xsl:for-each-group group-by="preceding-sibling::svrl:fired-rule[1]/@id" select="svrl:failed-assert[preceding-sibling::svrl:fired-rule/@role=$WorksheetErrorRole]">
...
concat(sps:singularizeSheetName($locationPrefix),&apos;[*]&apos;)"/>
						...
						<altova:level>
							...
							<table border="1">
								<xsl:variable name="altova:CurrContextGrid_0F3A9930" select="."/>
	...
	<xsl:function name="sps:singularizeSheetName" as="xs:string">
		...
		<xsl:sequence select="replace(replace(replace(replace(replace(replace(replace(replace(replace($sheetNameString,&apos;Facilities&apos;,&apos;Facility&apos;),&apos;Contacts&apos;,&apos;Contact&apos;),&apos;Floors&apos;,&apos;Floor&apos;),&apos;Spaces&apos;,&apos;Space&apos;),&apos;Zones&apos;,&apos;Zone&apos;),&apos;Types&apos;,&apos;Type&apos;),&apos;Components&apos;,&apos;Component&apos;),&apos;Attributes&apos;,&apos;Attribute&apos;),&apos;Systems&apos;,&apos;System&apos;)"/>
	</xsl:function>
