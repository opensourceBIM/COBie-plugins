...
public class JobTransformer extends ParentTransformer<org.erdc.cobie.sheetxmldata.JobType, JobType>
{

    public JobTransformer(org.erdc.cobie.sheetxmldata.JobType cobieSheetXMLData, JobType cobieLiteRowData, IndexedCOBie indexedCOBie)
    {
    ...
    protected ArrayList<COBieLiteParserDispatcher> getChildParsingDispatchers()
    {
        ...
        List<org.erdc.cobie.sheetxmldata.ResourceType> resources = getResources(target.addNewResources(), source.getResourceNames(),
                indexedCOBie);
