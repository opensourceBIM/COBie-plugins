...
import org.erdc.cobie.shared.deserializer.sheetxmldata.modelhandlers.IfcGuidHandler;
...
public class FacilityDeserializer
{
    ...
    {
        IfcGeometricRepresentationContext repContext = COBieUtility.ifcFactory.createIfcGeometricRepresentationContext();
        ...
        IfcAxis2Placement3D coordSystem = COBieUtility.ifcFactory.createIfcAxis2Placement3D();
        IfcCartesianPoint origin = COBieUtility.ifcFactory.createIfcCartesianPoint();
        ...
        IfcDirection refDirection = COBieUtility.ifcFactory.createIfcDirection();
        ...
        IfcDirection north = COBieUtility.ifcFactory.createIfcDirection();
