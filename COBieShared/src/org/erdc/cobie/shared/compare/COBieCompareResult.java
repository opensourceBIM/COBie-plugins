...
public class COBieCompareResult// extends SCompareResult
{
    ...
    public void initializeBiMServerCompare(long roid1, long roid2, ServiceInterface service, PluginInterface pluginInterface) throws ServerException, UserException, XmlException,
            IOException
    {
        // initializeState();
        this.roid1 = roid1;
