...
{
    //TODO:  This class duplicates the reponsibilities of org.erdc.cobie.shared.enums classes and needs to be refactored.  
    public static enum OutgingFileType
    {
        COBieSheetXMLData, 
        COBie, 
        COBieCompliance, 
        COBieSpatialDecompositionReport, 
        COBieRoomDataSheet, 
        COBieZoneReport, 
        COBieSystemReport, 
        COBieCompareReport, 
    ...
    public static final String COBIE_SPACE_REPORT_SERIALIALIZER_DEFAULT_NAME = COBieSerializerPluginInfo.REPORT_SPATIAL_DECOMPOSITION
            .toString();
    ...
    private static HashMap<OutgingFileType, String> getCobieFileTypeDescriptions()
    {
        ...
        cobieFileDescriptions.put(OutgingFileType.COBieSpatialDecompositionReport, COBieSerializerPluginInfo.REPORT_SPATIAL_DECOMPOSITION.getDescription());
    ...
    private static HashMap<OutgingFileType, String> getCobieFileTypeExtensions()
    {
        ...
        cobieFileExtensions.put(OutgingFileType.COBieSpatialDecompositionReport, COBieSerializerPluginInfo.REPORT_SPATIAL_DECOMPOSITION.getFileExtension());
    ...
    public static COBIEDocument getCOBieFromROID(long roid, PluginInterface pluginInterface, ServiceInterface serviceInterface) throws ServerException, UserException, XmlException,
            IOException
    {
