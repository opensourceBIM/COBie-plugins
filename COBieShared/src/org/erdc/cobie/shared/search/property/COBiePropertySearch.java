...
import org.erdc.cobie.utils.stringwriters.IfcRelationshipsToCOBie.ComparisonType;
...
public class COBiePropertySearch extends ModelSearchEngine<IfcRoot, String, IfcProperty>
{
    ...
    public boolean matchMetsThreshold()
    {
        ...
        if ((bestMatch != null) && (bestMatch.getSearchHit() != null))
        {
            ...
            ComparisonType compareType = org.erdc.cobie.utils.stringwriters.IfcRelationshipsToCOBie
