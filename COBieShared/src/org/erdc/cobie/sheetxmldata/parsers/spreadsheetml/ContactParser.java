...
public class ContactParser extends Parser
{
    ...
    public ContactParser(COBIEType cobie, Workbook workbook)
    {
    ...
    {
        return LoggerFactory.getLogger(ContactParser.class);
    }
    ...
    protected void write()
    {
        ...
        COBIEType.Contacts contacts = getCobie().addNewContacts();
