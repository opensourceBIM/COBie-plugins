...
public class SpareParser extends Parser
{
    ...
    public SpareParser(COBIEType cobie, Workbook workbook)
    {
    ...
    {
        return LoggerFactory.getLogger(SpareParser.class);
    }
    ...
    {
        COBIEType.Spares spares = getCobie().addNewSpares();
