...
import org.erdc.cobie.utils.serializer.RectangleCoordinatesCalculator;
...
public class GeometryHandler
{
    ...
    public IfcCartesianPoint newCartesianPointOrigin()
    {
        IfcCartesianPoint cartesianPoint = COBieUtility.ifcFactory.createIfcCartesianPoint();
    ...
    public IfcDirection newDefaultDirectionAxis3D()
    {
        IfcDirection direction = COBieUtility.ifcFactory.createIfcDirection();
    ...
    public IfcLocalPlacement newDefaultLocalPlacement(IfcLocalPlacement relativeTo)
    {
        IfcLocalPlacement localPlacement = COBieUtility.ifcFactory.createIfcLocalPlacement();
    ...
    public IfcAxis2Placement3D newDefaultPlacement3D()
    {
        IfcAxis2Placement3D defaultAxis2Placement3D = COBieUtility.ifcFactory.createIfcAxis2Placement3D();
    ...
    public IfcDirection newDefaultRefDirection3D()
    {
        IfcDirection direction = COBieUtility.ifcFactory.createIfcDirection();
    ...
    public IfcLocalPlacement newFloorLocalPlacement(FloorType floor, IfcLocalPlacement relativeTo)
    {
        IfcLocalPlacement localPlacement = COBieUtility.ifcFactory.createIfcLocalPlacement();
    ...
    public IfcAxis2Placement3D placement3DFromFloor(FloorType floor)
    {
