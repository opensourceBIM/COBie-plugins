...
public class ClassificationHandler
{
    ...
    public ClassificationHandler(COBieIfcModel cobieIfcModel, IfcGuidHandler ifcGuidProvider, OidProvider oidProvider,
            OwnerHistoryHandler ownerHistoryHandler)
    {
        model = cobieIfcModel;
    ...
    public List<IfcClassificationReference> classificationReferencesFromString(String categoryString)
    {
    ...
    private void classificationReferencesFromUnstructuredCategory(String categoryString, ArrayList<IfcClassificationReference> classificationReferences)
    {
    ...
    private void classificationReferencesFromNameAndCodeCategory(String categoryString, ArrayList<IfcClassificationReference> classificationReferences)
    {
        ...
        List<ClassificationCodeAndName> codeNames = 
                getCodeNamePairs(nameCategoryTokens);
        for(ClassificationCodeAndName codeAndName : codeNames)
        {
            String reformedCategoryString = codeAndName.classificationCode + COBieUtility.CLASSIFICATION_REFERENCE_NAME_SEPARATOR + codeAndName.classificationName;
    ...
    private List<ClassificationCodeAndName> getCodeNamePairs(String[] nameCategoryTokens)
    {
        ...
        if(tokenCount<=2)
        {
            if (tokenCount==2)
                ...
                simpleClassificationCodeName(new String[]{nameCategoryTokens[0], nameCategoryTokens[0]}, codeNames);
        }
        else
        {
    ...
    private void complexClassificationCodeNames(String[] nameCategoryTokens, List<ClassificationCodeAndName> codeNames)
    {
        ...
        {
            ClassificationCodeAndName codeName =
                    new ClassificationCodeAndName();
            ...
            //this doesn't work on the last entry because of the nextLefftIndex check...that is unecessary
