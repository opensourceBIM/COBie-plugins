...
import org.erdc.cobie.utils.deserializer.FloorDeserializer;
...
public class PropertySetHandler
{
    ...
    private void addEnumeratedValueContentsToModel(IfcPropertyEnumeratedValue propEnum)
    {
    ...
    private void addReferenceValueContentsToModel(IfcPropertyReferenceValue referenceValue)
    {
    ...
    private long getPropertySetOid(IfcPropertySetDefinition propertySetDefinition)
    {
        long propertySetOid;
