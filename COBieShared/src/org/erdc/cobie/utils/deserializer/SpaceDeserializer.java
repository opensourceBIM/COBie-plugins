...
public class SpaceDeserializer
{
    ...
    private final static String SPACE_COBIE_PROPERTY_SET_NAME = String.format(PropertySetHandler.fs_COBiePropertySetName, COBieUtility.CobieSheetName.Space.name());
    public static IfcElementQuantity baseQuantitiesPropertySetFromSpace(SpaceType cobieSpace, IfcOwnerHistory ownerHistory, IfcPropertySet psetSpaceCommon)
    {
        ...
        //if deriving quantities fail then try assigning them as property values
        try
        {
    ...
    public static IfcPropertySet spaceCommonPropertySetFromSpace(SpaceType cobieSpace)
    {
       ...
       // IfcPropertySingleValue usableHeight = usableHeightPropertyFromSpace(cobieSpace);
    ...
    public List<IfcClassificationReference> classificationReferencesFromSpace(SpaceType cobieSpace)
    {
            ...
            if (spaces != null)
            {
                for (SpaceType space : spaces.getSpaceArray())
                {
                    ...
                    if (!model.containsSpace(name))
                    {
                        ...
                        IfcElementQuantity psetBaseQuantities = SpaceDeserializer.baseQuantitiesPropertySetFromSpace(space, ownerHistory, psetSpaceCommon);
