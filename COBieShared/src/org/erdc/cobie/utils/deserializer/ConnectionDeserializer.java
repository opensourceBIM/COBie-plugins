...
public class ConnectionDeserializer
{
    ...
    private void deserializeBAMieConnection(ConnectionType bamieConnection, DocumentType sensorDocument)
    {
    ...
    private IfcDistributionPort distributionPortByName(
            String name,
            ...
            String controllerName)
    {
        ...
        IfcRelDefinesByType definesByType = COBieUtility.ifcFactory.createIfcRelDefinesByType();
    ...
    private void handleRelConnectsElements(ConnectionType connection, IfcRelConnectsElements connectsElements)
    {
    ...
    private void handleRelConnectsPorts(ConnectionType connection, IfcRelConnectsPorts connectsPorts)
    {
        String compName1 = connection.getRowName1();
        String compName2 = connection.getRowName2();
    ...
    private void handleRelConnectsPortToElement(ConnectionType connection, IfcRelConnectsPortToElement connectsPortsToElement)
    {
        ...
        IfcDistributionPort thePort = distributionPortByName(portName, theDistributionElement, connection.getCreatedBy(), connection.getCreatedOn(),
                connection.getExtSystem());
