...
public class IfcToType
{
    ...
    protected static String durationUnitsFromTypeObject(IfcTypeObject type, IfcModelInterface model)
    {
        ...
        propertyCOBieString = COBieUtility.cobiePsetStringFromStringMapAllowNA(valMap, expectedLifePropertyStrings);
        ...
        {
            durationUnit = COBieUtility.getFirstNamedUnitStringInProjectContext(model, IfcUnitEnum.TIMEUNIT);
        }
