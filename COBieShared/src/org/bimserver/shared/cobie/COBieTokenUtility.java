...
public class COBieTokenUtility
{
	...
	public static final ArrayList<String> AssemblyColumnNames =
	...
	{	Name,
		...
		public static ArrayList<String> AttributeColumnNames = new ArrayList<String>(
				Arrays.asList("Name", "CreatedBy", "CreatedOn", "Category",
						"SheetName", "RowName", "Value", "Unit", "ExtSystem",
		...
		public static enum AttributeColumnNameLiterals {
			Name, CreatedBy, CreatedOn, Category, SheetName, RowName, Value, Unit, ExtSystem, ExtObject, 
		...
		public static enum ContactColumnNameLiterals 
			...
			public static ArrayList<String> FacilityColumnNames =
					new ArrayList<String>(Arrays.asList("Name",
			"CreatedBy",
			"CreatedOn",
			"Category",
			...
			public static ArrayList<String> SpaceColumnNames = 
