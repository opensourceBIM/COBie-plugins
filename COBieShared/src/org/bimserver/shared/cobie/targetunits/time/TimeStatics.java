...
import org.bimserver.shared.cobie.targetunits.volume.VolumeStatics.Metric;
...
public class TimeStatics
{
	...
	public static class SecondsStatics
	{
		...
		public static final String[] UNIT_STRINGS =
				{"seconds",UNIT_NAME.name(),
					"seconds (s)","sec.","s","sec","second (s)","second"
				};
	...
	public static class MinuteStatics
	{
		...
		public static final IfcReal CONVERSION_FACTOR = PropertyUtility.initializeRealToStringVal
				(String.valueOf(NATIVE_TO_DERIVED));
	}
