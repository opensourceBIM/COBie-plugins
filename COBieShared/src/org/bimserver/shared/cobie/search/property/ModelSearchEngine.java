 ...
 *
 * @param <S> the search target type
 * @param <T> the search term type
 * @param <K> the match type
 */
public abstract class ModelSearchEngine<S,T,K> 
{
	...
	protected void setNewKeywordBestMatch(T searchString, K property,
			double distance)
	{
		COBieSearchHit<T,K> searchHit =
				new COBieSearchHit<T, K>(searchString, property, distance);
