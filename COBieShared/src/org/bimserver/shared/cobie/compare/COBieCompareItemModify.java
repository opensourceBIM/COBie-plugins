...
public class COBieCompareItemModify extends COBieCompareItem
{
	...
	private boolean valueIsModified(String cobie1Val, String cobie2Val)
	{
		...
		if(!equal && cobie1Val.contains(COBieUtility.getCOBieDelim()) &&
				cobie2Val.contains(COBieUtility.getCOBieDelim()))
		{
			equal = calculateEqualityBasedOnDelimmitedList(cobie1Val,
					cobie2Val);
		}
		if(!equal)
	...
	private boolean calculateEqualityBasedOnDelimmitedList(String cobie1Val,
			String cobie2Val)
	{
		boolean equal = true;
		ArrayList<String> cobie1Strings =
				COBieUtility.arrayListFromDelimString(cobie1Val);
		ArrayList<String> cobie2Strings =
				COBieUtility.arrayListFromDelimString(cobie2Val);
	...
	private boolean calculateEqualityOfValues(String cobie1Val,
			String cobie2Val)
	{
		boolean equal = false;
		try
