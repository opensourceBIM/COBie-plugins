...
public enum COBieSerializerPluginInfo implements PluginInfo
{
    ...
    SPREADSHEET_XLSX_DESIGN("COBie Spreadsheet (XLSX) - Design Phase","Construction Operators Building information exchange in an XLSX file color coded for the design phase.", SerializableFileType.XLSX,"org.bimserver.cobie.shared.bimserver.plugins.serializers.COBieDesignXLSXSerializerPlugin"),
    SPREADSHEET_XLSX_CONSTRUCTION("COBie Spreadsheet (XLSX) - Construction Phase","Construction Operators Building information exchange in an XLSX file color coded for the Construction phase.", SerializableFileType.XLSX,"org.bimserver.cobie.shared.bimserver.plugins.serializers.COBieConstructionXLSXSerializerPlugin"),
