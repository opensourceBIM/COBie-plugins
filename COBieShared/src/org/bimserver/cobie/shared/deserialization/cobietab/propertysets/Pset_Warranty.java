...
public class Pset_Warranty extends IfcPropertySetImpl
{
    ...
    {
        CaseInsensitiveMap indexedProperties = indexPropertySetByName(propertySet);       
    ...
    private void handleField(Pset_Warranty_Field psetWarrantyField, CaseInsensitiveMap indexedProperties)
    {
        IfcProperty property = (IfcProperty)indexedProperties.get(psetWarrantyField.name());
    ...
    private CaseInsensitiveMap  indexPropertySetByName(IfcPropertySet propertySet)
    {
        CaseInsensitiveMap propertyNameProperty = new CaseInsensitiveMap();
        for(IfcProperty property : propertySet.getHasProperties())
        {
