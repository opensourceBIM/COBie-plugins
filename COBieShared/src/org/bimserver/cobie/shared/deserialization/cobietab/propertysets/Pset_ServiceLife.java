package org.bimserver.cobie.shared.deserialization.cobietab.propertysets;
...
public class Pset_ServiceLife extends IfcPropertySetImpl
{
    ...
    {
        actualservicelife, expectedservicelife, optimisticreferenceservicelife, pessimisticreferenceservicelife, referenceservicelife, productiontransport, other, notknown, unset
    }
    ...
    private static final Map<ServiceLifeProperty, String> PropertyDescriptions = new HashMap<ServiceLifeProperty, String>()
    {
        /**
				 * 
				 */
    ...
    {
        IfcPropertySingleValue serviceLifeDuration = Ifc2x3tc1Factory.eINSTANCE.createIfcPropertySingleValue();
        ...
        getHasProperties().add(serviceLifeDuration);

        IfcPropertyEnumeratedValue serviceLifeType = Ifc2x3tc1Factory.eINSTANCE.createIfcPropertyEnumeratedValue();
        ...
        IfcPropertyEnumeration svcEnum = Ifc2x3tc1Factory.eINSTANCE.createIfcPropertyEnumeration();
        svcEnum.setName(getServiceLifeEnumerationName());
        for (ServiceLifeType svcType : ServiceLifeType.values())
        {
            IfcLabel lbl = PropertyUtility.initializeLabel(svcType.toString());
            svcEnum.getEnumerationValues().add(lbl);
        }
        serviceLifeType.setEnumerationReference(svcEnum);
        getHasProperties().add(serviceLifeType);
    ...
    public void setServiceLifeDuration(String duration)
    {
        ...
        if (!COBieIfcUtility.isValueSetAsStringNA(durationReal))
        {
            PropertySetUtility.setPropertySetPropertyValueOfName(ServiceLifeProperty.ServiceLifeDuration.toString(), this, durationReal);
        }
    }
    ...
    public void setServiceLifeDurationAndUnit(String duration, String unit)
    {
        ...
        if (!COBieUtility.isNA(unit))
        {
            ...
            PropertySetUtility.setPropertySetPropertyUnitNameOf(ServiceLifeProperty.ServiceLifeDuration.toString(), this,
                    durationUnits.getMatchedUnit());
        }
    ...
    public void setServiceLifeType()
    {
        ...
        {
            if (property.getName().equals(ServiceLifeProperty.ServiceLifeType.toString()) && (property instanceof IfcPropertyEnumeratedValue))
            {
                IfcPropertyEnumeratedValue svcLifeType = (IfcPropertyEnumeratedValue)property;
