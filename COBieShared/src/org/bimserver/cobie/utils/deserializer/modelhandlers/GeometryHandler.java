...
public class GeometryHandler
{
	...
	public IfcLocalPlacement newDefaultLocalPlacement(IfcLocalPlacement relativeTo)
	{
		IfcLocalPlacement localPlacement =
				COBieUtility.ifcFactory.createIfcLocalPlacement();
	...
	{
		IfcAxis2Placement3D defaultAxis2Placement3D =
	...
	public static Vector<Double> vectorFromLocalPlacement(IfcLocalPlacement localPlacement)
	{
		...
		if(localPlacement.getRelativePlacement() instanceof IfcAxis2Placement3D)
		{
			...
			if(localPlacementPoint.size()==RectangleCoordinatesCalculator.THREE_D_DIMENSION_COUNT)
			{
				...
				{
					Vector<Double> parentLocation =
							vectorFromLocalPlacement((IfcLocalPlacement)
									localPlacement.getPlacementRelTo());
