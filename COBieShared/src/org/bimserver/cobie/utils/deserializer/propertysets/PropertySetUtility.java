...
public class PropertySetUtility 
{
	...
	public static void setPropertySetPropertyValueOfNameAndUnit(String propertyName,IfcPropertySet propertySet,
			IfcValue value,IfcUnit units)
	{
		if (PropertyUtility.shouldSetProperty(propertyName,value))
		{
			for(IfcProperty property : propertySet.getHasProperties())
	...
	private static void setPhysicalProperty(IfcValue value, IfcUnit units,
	...
	private static void setSingleValueProperty(IfcValue value, IfcUnit units,
			IfcProperty property)
	{
		IfcPropertySingleValue singValue =
				(IfcPropertySingleValue) property;
