...
import org.bimserver.shared.cobie.COBieTokenUtility.TypeColumnNameLiterals;
...
public class Pset_Warranty extends IfcPropertySetImpl
{
	...
	private static final String pName_WarrantyGuarantorParts = 
			TypeColumnNameLiterals.WarrantyGuarantorParts.toString();
	...
	private static final String pName_WarrantyDurationParts =
			TypeColumnNameLiterals.WarrantyDurationParts.toString();
	...
	private static final String pName_WarrantyGuarantorLabor =
			TypeColumnNameLiterals.WarrantyGuarantorLabor.toString();
	...
	private static final String pName_WarrantyDurationLabor =
			TypeColumnNameLiterals.WarrantyDurationLabor.toString();
	...
	private void setWarrantyDurationParts(String duration,String durationUnits)
	{
		...
		if(!COBieUtility.isNA(durationUnits))
		{
			durationUnit = durationUnitsFromString(durationUnits);
				PropertySetUtility.
				setPropertySetPropertyUnitNameOf(pName_WarrantyDurationParts,this,durationUnit);
	...
	private void setWarrantyDurationLabor(String duration,String durationUnits)
	{
		...
		if(!COBieUtility.isNA(durationUnits))
		{
			durationUnit = durationUnitsFromString(durationUnits);
				PropertySetUtility.
				setPropertySetPropertyUnitNameOf(pName_WarrantyDurationLabor,this,durationUnit);
