...
public class IfcEnumeratedValueToCOBieString extends IfcPropertyToCOBieString 
{
	...
	{
		super(property);
		this.enumeratedValuesStrings = new ArrayList<String>();
		this.enumerationReferenceStrings = new ArrayList<String>();
		if(property.getEnumerationReference()!=null && property.getEnumerationReference().getUnit()!=null)
			...
			this.setUnitString(COBieUtility.COBieNA);
	...
	private void setEnumeratedValuesStrings(EList<IfcValue> values) 
	{
		...
		{
			enumeratedValuesStrings.add(IfcSingleValueToCOBieString.getValueStringFromValue(val));
		}
	}
