...
public class IfcPropertySetToCOBieString
{
	...
	static public Map<String,IfcPropertyToCOBieString> mergePsetStringsAllowNA(Map<String,IfcPropertyToCOBieString> tmpPropertyMap, Map<String,IfcPropertyToCOBieString> propertyMap)
	{
		Map<String,IfcPropertyToCOBieString> clonePMap = clonePsetStringMap(propertyMap);
		IfcPropertyToCOBieString tmpVal1;
		IfcPropertyToCOBieString tmpVal2;
	...
	(Map<String,IfcPropertyToCOBieString> psetStrings, IfcPropertySetDefinition pSetDef)
	{
