...
public class IfcToSpare 
{
	...
	{
		String suppliers;
		ArrayList<String> suppliersPropertyNames =
				getSuppliersPropertyNames();
		suppliers = IfcRelationshipsToCOBie.getHighestRankingPropertyStringFromRelDefinesList(productResource.getIsDefinedBy(),suppliersPropertyNames,false);
	...
	{
		ArrayList<String> setNumberPropertyNames =
				getSetNumberPropertyNames();
		String setNumber = productResource.getResourceGroup();
		if(COBieUtility.isNA(setNumber))
			setNumber = IfcRelationshipsToCOBie.getHighestRankingPropertyStringFromRelDefinesList(productResource.getIsDefinedBy(),setNumberPropertyNames,false);	
