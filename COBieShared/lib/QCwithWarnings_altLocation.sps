...
<structure version="16" html-doctype="XHTML1 Transitional" compatibility-view="IE7" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="0" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	<parameters>
		<parameter name="Title" default="COBie QC report - Design Deliverable"/>
	</parameters>
	<schemasources>
		<namespaces>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="C:\Users\Bogen\Documents\Java\cobieBIMServerCodes\COBieSchema\COBieSheetXMLData\validation\reports\stylevision\svrl.xsd" workingxmlfile="sampleSVRL_altLocation.xml"/>
		</schemasources>
	</schemasources>
	<modules/>
	<flags>
			...
			<globaltemplate subtype="main" match="/">
				...
				<children>
					...
					<paragraph paragraphtag="h1">
						<children>
							<template subtype="uservariable" match="$Title">
								<children>
					...
					<paragraph paragraphtag="p">
						...
						<children>
							<text fixtext="Save a new copy of your COBie spreadsheet to a new file. The errors in this report will match by Worksheet Name, Row Number, and object name to the data in your file.  For example, a problem with the fifth space, named &quot;Vestibule,&quot; willbe listed as Space[5]:Vestibule.  Once each relevant issue is fixed, re-run your file. "/>
						</children>
					</paragraph>
					<paragraph>
																...
																<children>
																	<template subtype="userdefined" match="current-grouping-key()">
																					...
																					<tgridcell>
																						<children>
																							<link>
																								...
																								<hyperlink>
																									<fixtext value="#count"/>
																									<xpath value="string($worksheetName)"/>
																								</hyperlink>
																							</link>
																						</children>
																					</tgridcell>
																		...
																		<variables>
																			...
																			<variable name="errorCount" value="if (string($rowCount)!=&apos;NaN&apos; and $rowCount&gt;0) then string(count(distinct-values($failedAsserts[not(sps:isAssertWarning(@id))]/svrl:text/*:location))) else &apos;n/a&apos;" valuetype="xs:string"/>
																			<variable name="moreThanOneRow" value="$rowCount=$rowCount and $rowCount&gt;0" valuetype="xs:boolean"/>
																			<variable name="warningCount" value="if (string($rowCount)!=&apos;NaN&apos; and $rowCount&gt;0) then string(count(distinct-values($failedAsserts[sps:isAssertWarning(@id)]/*:text/*:location))) else &apos;n/a&apos;" valuetype="xs:string"/>
																		</variables>
																	</template>
																</children>
																<variables>
...
$worksheetName" valuetype="xs:string"/>
																	<variable name="successfulReport" value="following-sibling::*:successful-report[1]/*:text/text()[1]" valuetype="xs:string"/>
									...
									<template subtype="uservariable" groupingtype="group-by" groupingmatch="preceding-sibling::svrl:fired-rule[1]/@id" match="$errorRoleContent">
																							...
																							<conditionbranch xpath="$isWorksheet">
																								<children>
																									<bookmark>
																										...
																										<bookmark>
																											<fixtext value="count"/>
																											<xpath value="substring-after($ruleGroupName, &apos;COBie.&apos;)"/>
																										</bookmark>
																									</bookmark>
																								</children>
																							</conditionbranch>
															...
															<template subtype="userdefined" groupingtype="group-by" groupingmatch="@flag" match="current-group()">
																<children>
																	<template subtype="userdefined" match="current-grouping-key()">
																		...
																		<variables>
																			<variable name="incorrectFieldOccurenceCount" value="count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos; and not(sps:isAssertWarning(@id))]/svrl:text/*:location))" valuetype="xs:integer"/>
															...
															<template subtype="userdefined" groupingtype="group-by" groupingmatch="@flag" match="current-group()">
																<children>
																	<template subtype="userdefined" match="current-grouping-key()">
																		...
																		<variables>
																			<variable name="incorrectFieldOccurenceCount" value="count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos; and sps:isAssertWarning(@id)]/*:text/location))" valuetype="xs:integer"/>
																			<variable name="incorrectFieldOccurencesMessage" value="concat(concat(string(current-grouping-key()),string(&apos;: &apos;)),string($incorrectFieldOccurenceCount))" valuetype="xs:string"/>
																		</variables>
																	</template>
																	<condition>
										...
										<variables>
											...
											<variable name="countTotalSheetRows" value="count(distinct-values(current-group()/*:text/*:location))" valuetype="xs:integer"/>
											<variable name="countDistinctRowErrors" value="count(distinct-values(current-group()[name(self::element())=&apos;svrl:failed-assert&apos; and not(sps:isAssertWarning(@id))]/*:text/*:location))" valuetype="xs:integer"/>
											<variable name="distinctRules" value="distinct-values(current-group()[name(.)=&apos;svrl:successful-report&apos;]/svrl:text/text()[1])" valuetype="&lt;auto&gt;"/>
								...
								<children>
									...
									<template subtype="userdefined" groupingtype="group-by" groupingmatch="preceding-sibling::svrl:fired-rule[1]/@id" match="$errorRoleContent[name(.)=&apos;svrl:failed-assert&apos;]">
											...
											<level>
												<children>
													...
													<template subtype="userdefined" groupingtype="group-by" groupingmatch="@id" match="current-group()">
																	...
																	<paragraph paragraphtag="p">
																		...
																		<children>
																			<template subtype="userdefined" match="current-group()">
																				...
																				<variables>
																					<variable name="RowNumber" value="number(substring-after(sps:COBieLocationHeading(current()/*:text/*:location),&apos; &apos;))+1" valuetype="xs:double"/>
																				</variables>
																			</template>
																		</children>
																	</paragraph>
														...
														<variables>
															<variable name="formattedLocation" value="sps:COBieLocationHeading( *:text/*:location )" valuetype="xs:string"/>
															<variable name="cobieRowName" value="substring-before(svrl:text/text()[1] ,&apos;:&apos; )" valuetype="xs:string"/>
										...
										<variables>
											<variable name="ruleGroupName" value="string(current-grouping-key())" valuetype="xs:string"/>
											<variable name="isWorksheet" value="string-length($ruleGroupName)-string-length(translate($ruleGroupName,&apos;.&apos;,&apos;&apos;))=1" valuetype="xs:boolean"/>
											<variable name="errorCount" value="count(distinct-values(current-group()[not(sps:isAssertWarning(@id))]/*:text/*:location))" valuetype="xs:integer"/>
											<variable name="warningCount" value="count(distinct-values(current-group()[sps:isAssertWarning(@id)]/*:text/*:location))" valuetype="xs:integer"/>
										</variables>
									</template>
								</children>
							</level>
										...
										<children>
											<level>
												<children>
													...
													<template subtype="userdefined" groupingtype="group-by" groupingmatch="*:text/*:location" match="current-group()">
														<children>
															<level>
																<children>
																	<marker name="Level2Section">
																															...
																															<tgridcell>
																																<children>
																																	<template subtype="element" match="svrl:text">
																																		<children>
																																			<template subtype="userdefined" match="text()[1]">
																																				<children>
																																					<content subtype="regular"/>
																																				</children>
																																				<variables/>
...
false()" valuetype="xs:boolean"/>
	...
	<xpath-functions>
		<xpath-function name="COBieLocationHeading" value="replace(replace($cobiePathString,&apos;\[&apos;,&apos; &apos;),&apos;\]&apos;,&apos;&apos;)" valuetype="xs:string"/>
		<xpath-function-name>
			<variable name="cobiePathString"/>
		</xpath-function-name>
	</xpath-functions>
</structure>
