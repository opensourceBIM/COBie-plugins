...
public final class FacilityAttribute extends Relationship
{
	...
	public FacilityAttribute() throws CobieSQLiteException
	{
		super();
	}
	
    public FacilityAttribute(Row row) throws CobieSQLiteException
    {
    	super(row);
    }
