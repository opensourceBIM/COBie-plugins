...
public final class SpaceAttribute extends Relationship
{
	...
	public SpaceAttribute() throws CobieSQLiteException
	{
		super();
	}
	
    public SpaceAttribute(Row row) throws CobieSQLiteException
    {
    	super(row);
    }
